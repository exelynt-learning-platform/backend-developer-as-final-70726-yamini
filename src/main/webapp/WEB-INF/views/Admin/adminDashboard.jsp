...
<div class="main">
    ...
    <header class="topbar">
        ...
        <div class="admin-info">
            ...
            <span class="admin-name" id="adminName">
                Administrator
            </span>
...
<script>
    ...
    function displayAdminName() {
        ...
        /*
         * Email is stored by login.jsp
         * only if we decide to store it there.
         *
         * For now Administrator is displayed.
         */
